...
export type StageRenderer = Pick<THREE.WebGLRenderer, 'domElement' | 'setSize' | 'setPixelRatio' | 'getPixelRatio' | 'getDrawingBufferSize' | 'render' | 'info' | 'shadowMap' | 'outputColorSpace' | 'toneMapping' | 'dispose'>;
...
export declare function refuseBackend(kind: BackendKind): never;
//# sourceMappingURL=stageBackend.d.ts.map