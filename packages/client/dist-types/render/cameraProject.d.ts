...
export declare function snapCam(v: number, snapDpr: number): number;
/**
 ...
 */
export declare function camOriginX(scale: number, camX: number, snapDpr: number, w: number, q?: number): number;
export declare function camOriginY(scale: number, yScale: number, camY: number, snapDpr: number, h: number, q?: number): number;
/**
 ...
 * viewport centre.
 */
export declare function projectWorld(scale: number, yScale: number, camX: number, camY: number, q: number, snapDpr: number, wx: number, wy: number, w: number, h: number, out: XY): XY;
/**
 ...
 */
export declare function depthScaleWorld(scale: number, yScale: number, camY: number, q: number, wy: number): number;
/**
 ...
 */
export declare function depthScaleAtScreen(q: number, h: number, sy: number): number;
/**
 ...
 */
export declare function unprojectScreen(scale: number, yScale: number, camX: number, camY: number, q: number, snapDpr: number, sx: number, sy: number, w: number, h: number, out: XY): XY;
/**
 ...
 */
export declare function horizonScreenY(q: number, h: number): number;
 ...
 */
export declare function lightmapStrip(q: number, viewW: number, viewH: number, mh: number, strips: number, i: number, out: LightStrip): LightStrip;
/**
 ...
 */
export declare function screenOrthoFromLean(q: number, cx: number, cy: number, sx: number, sy: number, out: XY): XY;
/**
 ...
 */
export declare function shadeStrip(q: number, cx: number, cy: number, rectX: number, rectY: number, rectW: number, rectH: number, srcH: number, strips: number, i: number, out: LightStrip): LightStrip;
//# sourceMappingURL=cameraProject.d.ts.map