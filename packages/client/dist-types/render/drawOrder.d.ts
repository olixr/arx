...
export declare const SHELF: (v: number | undefined) => number;
export declare const DRAW_ORDER: (a: DrawOrderItem, b: DrawOrderItem) => number;
//# sourceMappingURL=drawOrder.d.ts.map