 ...
 */
export declare const POOL_MAX_SLOTS = 1480;
export declare const POOL_MAX_BYTES: number;
export declare const POOL_SLOT_MAX_BYTES: number;
/** Why a bake was let through, or what turned it away. */
export declare const enum BandVerdict {
    Admit = 0,
 ...
 * canvas is acquired.
 */
export declare function admitBand(ledgerBytes: number, bytes: number): BandVerdict;
...
export declare function bandSweepNeeded(count: number, ledgerBytes: number): boolean;
/** When the caller may stop dropping. */
export declare function bandSweepRelieved(count: number, ledgerBytes: number): boolean;
/**
 ...
 */
export declare function planBandSweep(entries: readonly BandSweepEntry[], frameNo: number, camCx: number, camCy: number): string[];
/** Law 5: may this canvas be parked for reuse, or does it go to GC? */
export declare function poolAdmits(poolCount: number, poolBytes: number, bytes: number): boolean;
//# sourceMappingURL=bandBudget.d.ts.map