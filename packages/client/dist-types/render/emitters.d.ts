 ...
 * globals or the DOM.
 */
import { type EmitterSpec } from '@arx/shared';
 ...
 */
export declare function collectEmitter(spec: EmitterSpec, tx: number, ty: number, t: number, flame: number, boost: number, yScale: number, deckLift: number, glows: EmitterGlowOut[], lights: WorldLight[]): boolean;
