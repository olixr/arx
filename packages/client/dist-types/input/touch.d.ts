 ...
 */
export declare function setupTouch(input: InputManager, game: ClientGame, renderer: Renderer, canvas: HTMLCanvasElement, onInteractTap: (tx: number, ty: number) => boolean, onZoomChange?: () => void): void;
