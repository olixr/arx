...
function golden(
  ...
  if (tile === Tile.Campfire) {
    ...
    glows.push({ x: tx + 0.5, y: ty + 0.32, r: 1.6 * flick, rgb: '235, 140, 52', a: 0.3 * flick * boost });
    ...
    glows.push({ x: tx + 0.5, y: ty + 0.75, r: 1.15, rgb: '232, 108, 45', a: 0.24 * pulse * boost });
    ...
    glows.push({ x: tx + 0.5, y: ty + 0.45, r: 1.4 * pulse, rgb: '235, 150, 62', a: 0.26 * pulse * boost });
    lights.push({ x: tx + 0.5, y: ty + 0.7, r: 4.2, rgb: [255, 190, 120], intensity: 0.85 * flame * pulse, occlude: true });
  } else if (tile === Tile.Brazier) {
    const flick = 0.85 + Math.sin(t * 11 + tx * 3.1) * 0.1 + Math.sin(t * 23 + ty) * 0.05;
    glows.push({ x: tx + 0.5, y: ty + 0.3, r: 1.5 * flick, rgb: '255, 158, 66', a: 0.3 * flick * boost });
    ...
    glows.push({ x: tx + 0.5, y: ty - 1.1 / yScale, r: 1.15 * flick, rgb: '255, 156, 62', a: 0.28 * flick * boost });
    ...
    glows.push({ x: tx + 0.5, y: ty + 0.18, r: 0.85 * flick, rgb: '255, 190, 100', a: 0.24 * flick * boost });
    ...
    glows.push({ x: tx + 0.5, y: ty + 0.1, r: 1.1 * flick, rgb: '255, 150, 58', a: 0.28 * flick * boost });
    ...
    glows.push({ x: tx + 0.5, y: ty + 0.1, r: 2.3 * flick, rgb: '240, 132, 48', a: 0.34 * flick * boost });
    ...
    glows.push({ x: tx + 0.5, y: ty + 0.18, r: 1.4 * flick, rgb: '255, 150, 60', a: 0.3 * flick * boost });
    ...
    glows.push({ x: tx + 0.5, y: ty + 0.62, r: 0.8 * pulse, rgb: '240, 120, 45', a: 0.2 * pulse * boost });
    ...
    glows.push({ x: tx + 0.5, y: ty + 0.4, r: 0.95 * pulse, rgb: '110, 225, 200', a: 0.12 * pulse * boost });
    ...
    glows.push({ x: tx + 0.5, y: ty - 1.0 / yScale, r: 1.0 * pulse, rgb: '127, 216, 200', a: 0.16 * pulse * boost });
    ...
    glows.push({ x: tx + 0.5, y: ty + 0.3, r: 0.7 * pulse, rgb: '170, 216, 226', a: 0.1 * pulse * boost });
    ...
    glows.push({ x: tx + 0.5, y: ty - 0.45, r: 1.1 * breathe, rgb: '180, 143, 232', a: 0.22 * breathe * boost });
    ...
    glows.push({ x: tx + 0.5, y: ty + 0.1, r: 0.7 * breathe, rgb: '180, 143, 232', a: 0.12 * breathe * boost });
    ...
    glows.push({ x: tx + 0.5, y: ty + 0.35, r: 1.0 * breathe, rgb: '127, 232, 168', a: 0.15 * breathe * boost });
    ...
    glows.push({ x: tx + 0.5, y: ty - 0.3, r: 0.8 * breathe, rgb: '180, 143, 232', a: 0.13 * breathe * boost });
    ...
    glows.push({ x: tx + 0.5, y: ty - 0.35, r: 0.6 * breathe, rgb: '216, 196, 250', a: 0.12 * breathe * boost });
    ...
    glows.push({ x: tx + 0.5, y: ty + 0.06, r: 1.7 * beat, rgb: '223, 242, 255', a: 0.26 * beat * boost });
    ...
    glows.push({ x: tx + 0.5, y: ty + 0.42, r: 1.2 * swell, rgb: '159, 232, 216', a: 0.16 * swell * boost });
    ...
    glows.push({ x: tx + 0.5, y: ty + 0.12, r: 0.65 * pulse, rgb: '159, 232, 216', a: 0.1 * pulse * boost });
