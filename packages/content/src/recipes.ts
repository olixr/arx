...
const defs: Array<Omit<RecipeDef, 'unlock'>> = [
  ...
  // THE FULL FIELD (farming v2 Phase 2): the crop kitchen returns
  // above L15 — plain hearth food off the new staples and orchard,
  // every new yield with a pot to land in (the consumer law).
  {
    id: 'cook_baked_potato',
    name: 'Baked potato',
    skill: 'cooking',
    levelReq: 3,
    xp: 30,
    station: 'fire',
    inputs: [{ item: 'potato', qty: 1 }],
    output: { item: 'baked_potato', qty: 1 },
    ticks: 32,
    burnChance: 0.25,
    burnResult: 'burnt_food',
  },
  {
    ...
    xp: 50,
    station: 'fire',
    inputs: [{ item: 'onion', qty: 2 }],
    output: { item: 'onion_soup', qty: 1 },
    ticks: 40,
    burnChance: 0.22,
    burnResult: 'burnt_food',
  },
  {
    id: 'cook_hearty_pottage',
    name: 'Hearty pottage',
    skill: 'cooking',
    levelReq: 14,
    xp: 75,
    ...
    output: { item: 'hearty_pottage', qty: 1 },
    ticks: 48,
    burnChance: 0.2,
    burnResult: 'burnt_food',
  },
  {
    id: 'cook_roast_pumpkin',
    name: 'Roast pumpkin',
    skill: 'cooking',
    levelReq: 25,
    xp: 150,
    station: 'fire',
    inputs: [{ item: 'pumpkin', qty: 1 }],
    output: { item: 'roast_pumpkin', qty: 1 },
    ticks: 55,
    burnChance: 0.2,
    burnResult: 'burnt_food',
  },
  {
    id: 'cook_orchard_crumble',
    ...
    output: { item: 'orchard_crumble', qty: 1 },
    ticks: 58,
    burnChance: 0.2,
    burnResult: 'burnt_food',
  },
  {
    id: 'cook_barley_porridge',
    ...
    output: { item: 'barley_porridge', qty: 1 },
    ticks: 60,
    burnChance: 0.18,
    burnResult: 'burnt_food',
  },
  {
    id: 'cook_roast_redroot',
    name: 'Roast redroot',
    skill: 'cooking',
    levelReq: 48,
    xp: 280,
    station: 'fire',
    inputs: [{ item: 'redroot', qty: 2 }],
    output: { item: 'roast_redroot', qty: 1 },
    ticks: 66,
    burnChance: 0.22,
    burnResult: 'burnt_food',
  },
  ...
  },
  {
    ...
    station: 'fire',
    inputs: [
      { item: 'kingsquash', qty: 1 },
      { item: 'egg', qty: 1 },
      { item: 'flour', qty: 1 },
    ],
    output: { item: 'kingsquash_bake', qty: 1 },
    ticks: 80,
    burnChance: 0.2,
    burnResult: 'burnt_food',
  },
  ...
  // THE FULL FIELD (farming v2 Phase 2): the high herbs open the road
  // past 40 — the bridge brews (the full ladder lands with THE LADEN
  // TABLE). The dark pair keeps the found-never-taught law.
  {
    id: 'brew_greater_tincture',
    ...
    station: 'alembic',
    inputs: [
      { item: 'bittercress', qty: 2 },
      { item: 'berries', qty: 1 },
    ],
    output: { item: 'greater_healing_tincture', qty: 1 },
    ticks: 70,
  },
  {
    // THE RENDERED SAC: the grown supply line into every venom oil —
    // adder's tongue feeds the same glands the wilds drop.
    id: 'render_venom_sacs',
    name: 'Render venom sac',
    skill: 'herbalism',
    levelReq: 45,
    xp: 240,
    station: 'alembic',
    inputs: [{ item: 'venom_sac', qty: 1 }],
    output: { item: 'venom_gland', qty: 2 },
    ticks: 55,
  },
  {
    id: 'brew_silverleaf_salve',
    ...
    station: 'alembic',
    inputs: [
      { item: 'silverleaf', qty: 2 },
      { item: 'milk', qty: 1 },
    ],
    output: { item: 'silverleaf_salve', qty: 1 },
    ticks: 75,
  },
  {
    id: 'brew_palegill_oil',
    name: 'Palegill oil',
    skill: 'herbalism',
    levelReq: 60,
    xp: 330,
    station: 'alembic',
    inputs: [
      { item: 'spore_dust', qty: 2 },
      { item: 'venom_gland', qty: 1 },
    ],
    output: { item: 'palegill_oil', qty: 1 },
    ticks: 80,
  },
  // THE LADEN TABLE: the buff kitchen to 88 — the farmer feeds the
  // raid (royal banquet asks for PRIME inputs by name).
  {
    id: 'cook_honeyed_carrots',
    ...
    output: { item: 'honeyed_carrots', qty: 1 },
    ticks: 56,
    burnChance: 0.2,
    burnResult: 'burnt_food',
  },
  {
    ...
    output: { item: 'pumpkin_pie', qty: 1 },
    ticks: 64,
    burnChance: 0.18,
    burnResult: 'burnt_food',
  },
  {
    id: 'cook_shepherds_pie',
    name: "Shepherd's pie",
    skill: 'cooking',
    levelReq: 55,
    xp: 330,
    ...
    inputs: [
      { item: 'potato', qty: 2 },
      { item: 'smoked_beef', qty: 1 },
      { item: 'butter', qty: 1 },
    ],
    output: { item: 'shepherds_pie', qty: 1 },
    ticks: 70,
    burnChance: 0.18,
    burnResult: 'burnt_food',
  },
  {
    id: 'cook_orchard_tart',
    name: 'Orchard tart',
    skill: 'cooking',
    levelReq: 60,
    xp: 360,
    ...
    output: { item: 'orchard_tart', qty: 1 },
    ticks: 72,
    burnChance: 0.18,
    burnResult: 'burnt_food',
  },
  {
    id: 'cook_harvest_feast',
    name: 'Harvest feast',
    skill: 'cooking',
    levelReq: 75,
    xp: 460,
    ...
    output: { item: 'harvest_feast', qty: 1 },
    ticks: 84,
    burnChance: 0.16,
    burnResult: 'burnt_food',
  },
  {
    id: 'cook_royal_banquet',
    name: 'Royal banquet',
    skill: 'cooking',
    levelReq: 88,
    xp: 560,
    station: 'fire',
    inputs: [
      { item: 'kingsquash_prime', qty: 1 },
      { item: 'truffle_prime', qty: 1 },
      { item: 'butter_prime', qty: 1 },
      { item: 'honeybrew', qty: 1 },
    ],
    output: { item: 'royal_banquet', qty: 1 },
    ticks: 96,
    burnChance: 0.14,
    burnResult: 'burnt_food',
  },
  // THE LADEN TABLE: herbalism's ladder runs to 90. The master brews
  // ask for PRIME herbs by name — the first graded-input recipes
  // (grade scales magnitude through the tier; the alembic reads
  // labels, never luck).
  {
    id: 'brew_ironhide_draught',
    ...
    output: { item: 'ironhide_draught', qty: 1 },
    ticks: 74,
  },
  {
    id: 'brew_hunters_eye',
    ...
    output: { item: 'hunters_eye_brew', qty: 1 },
    ticks: 84,
  },
  {
    id: 'brew_prime_tincture',
    name: 'Prime tincture',
    skill: 'herbalism',
    levelReq: 75,
    xp: 430,
    station: 'alembic',
    inputs: [
      { item: 'bittercress_prime', qty: 2 },
      { item: 'honey', qty: 1 },
    ],
    output: { item: 'prime_tincture', qty: 1 },
    ticks: 90,
  },
  {
    id: 'brew_dawnfire_elixir',
    ...
    inputs: [
      { item: 'dawnveil', qty: 2 },
      { item: 'honey_fine', qty: 1 },
    ],
    output: { item: 'dawnfire_elixir', qty: 1 },
    ticks: 94,
  },
  {
    id: 'brew_master_draught',
    ...
    station: 'alembic',
    inputs: [
      { item: 'dawnveil_prime', qty: 2 },
      { item: 'honey_prime', qty: 1 },
    ],
    output: { item: 'master_draught', qty: 1 },
    ticks: 100,
  },
  ...
  },
  {
    ...
    station: 'alembic',
    inputs: [
      { item: 'duskthorn', qty: 2 },
      { item: 'moonbell', qty: 1 },
    ],
    output: { item: 'duskthorn_draught', qty: 1 },
    ticks: 85,
  },
  {
    id: 'brew_dawnveil_elixir',
    ...
    output: { item: 'dawnveil_elixir', qty: 1 },
    ticks: 95,
  },
];
...
const INLINE_UNLOCK: Record<string, RecipeUnlock> = {
  ...
  // THE FULL FIELD: the bridge brews. Bright branch taught, dark
  // branch found, as ever.
  brew_greater_tincture: 'trainer',
  brew_silverleaf_salve: 'trainer',
  render_venom_sacs: 'drop',
  brew_palegill_oil: 'drop',
  brew_duskthorn_draught: 'drop',
  brew_dawnveil_elixir: 'drop',
  // The crop kitchen's returns (cooking).
  cook_baked_potato: 'core',
  cook_onion_soup: 'core',
  cook_hearty_pottage: 'trainer',
  cook_roast_pumpkin: 'trainer',
  cook_orchard_crumble: 'trainer',
  ...
  // THE LADEN TABLE: the buff kitchen (taught) and the high shelf
  // (the top of each ladder is FOUND, as ever).
  cook_honeyed_carrots: 'trainer',
  cook_pumpkin_pie: 'trainer',
  cook_shepherds_pie: 'trainer',
  cook_orchard_tart: 'drop',
  cook_harvest_feast: 'drop',
  cook_royal_banquet: 'drop',
  brew_ironhide_draught: 'trainer',
  brew_hunters_eye: 'drop',
  brew_prime_tincture: 'trainer',
  brew_dawnfire_elixir: 'drop',
  brew_master_draught: 'drop',
};
