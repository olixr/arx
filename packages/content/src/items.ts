...
const defs: ItemDef[] = [
  ...
  { id: 'faewolf_pelt', name: 'Fae wolf pelt', stackable: true, maxStack: 5, value: 260, desc: 'Moon-lavender and cold to the hand years after the skinning. In the right dark it still glimmers, and the furrier will not say what the wrong dark is.', color: '#9a94b4', code: 'Fp' },
