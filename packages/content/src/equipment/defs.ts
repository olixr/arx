...
function namedChaseDefs(): EquipmentDef[] {
  ...
  return [
    ...
    chasePiece(redmarch, 'redmarch_helm', 'Redmarch helm', 'head', 37, 8, 1700, 'Na',
      'The officer’s crest worn ear to ear in legion stripes. The white light in the slit never sleeps.'),
    chasePiece(redmarch, 'redmarch_platebody', 'Redmarch platebody', 'body', 40, 11, 2050, 'Nb',
      'Watch fire red set with silver stars, a shield wall carried at the shoulders. One heart always burns while the others rest.'),
