...
export const EQUIPMENT_DEFS: EquipmentDef[] = [
  ...
  // THE SHIELD WAVE (docs/shield-wave-plan.md): twelve more walls,
  // every one owned by a faction, a boss, or a craft pinnacle that
  // already stands in the world. Trophies drop where their owners die
  // (the loot-story law); the crafted ones are trade pinnacles.
  {
    id: 'lowhall_breacher',
    name: 'Lowhall breacher',
    slot: 'offhand',
    levelReq: { skill: 'defence', level: 18 },
    armor: 5,
    affixPool: [{ stat: 'defence', w: 2 }, { stat: 'onehand' }, { stat: 'maxHp' }, { stat: 'sneak' }],
    acquisition: { drop: true },
    value: 320,
    color: '#4a3a30',
    code: 'Lw',
    desc: 'The Red Company\'s arguing door. The scars didn\'t buff out, and they know it.',
  },
  {
    id: 'legion_doorwall',
    name: 'Legion doorwall',
    slot: 'offhand',
    levelReq: { skill: 'defence', level: 22 },
    armor: 6,
    affixPool: [{ stat: 'defence', w: 2 }, { stat: 'onehand', w: 2 }, { stat: 'maxHp' }, { stat: 'vitality' }],
    acquisition: { drop: true },
    value: 420,
    color: '#3f434e',
    code: 'Dw',
    desc: 'Issue iron to the quartermaster\'s template. Ten thousand exist; this one is yours.',
  },
  {
    id: 'stagheart_palisade',
    name: 'Stagheart palisade',
    slot: 'offhand',
    levelReq: { skill: 'defence', level: 25 },
    armor: 7,
    affixPool: [{ stat: 'defence', w: 2 }, { stat: 'archery', w: 2 }, { stat: 'maxHp' }, { stat: 'vitality' }],
    acquisition: { craft: true },
    recipe: {
      skill: 'woodworking',
      levelReq: 30,
      ...
      inputs: [
        { item: 'yew_log', qty: 2 },
        { item: 'leather', qty: 2 },
        { item: 'turtle_scute', qty: 2 },
      ],
    },
    value: 560,
    color: '#b09a6e',
    code: 'Sq',
    desc: 'Fence, carried. Plant it at the treeline and shoot beside it all season.',
  },
  {
    id: 'fellhorn_gate',
    name: 'Fellhorn gate',
    slot: 'offhand',
    levelReq: { skill: 'defence', level: 26 },
    armor: 8,
    affixPool: [{ stat: 'defence', w: 2 }, { stat: 'vitality', w: 2 }, { stat: 'maxHp' }, { stat: 'regen' }],
    acquisition: { drop: true },
    value: 640,
    color: '#a89878',
    code: 'Fh',
    desc: 'A barrow door off its hinges, horns and all. The fell marks its gates; now you are one.',
  },
  {
    id: 'brinehold_carapace',
    name: 'Brinehold carapace',
    slot: 'offhand',
    levelReq: { skill: 'defence', level: 28 },
    armor: 9,
    affixPool: [{ stat: 'defence', w: 2 }, { stat: 'regen', w: 2 }, { stat: 'maxHp' }, { stat: 'vitality' }],
    acquisition: { craft: true },
    recipe: {
      skill: 'smithing',
      levelReq: 36,
      ...
      ticks: 105,
      inputs: [
        { item: 'crab_carapace', qty: 3 },
        { item: 'colossus_plate', qty: 1 },
        { item: 'steel_bar', qty: 1 },
        { item: 'deepking_pearl', qty: 1 },
      ],
    },
    value: 720,
    color: '#46655c',
    code: 'Bq',
    desc: 'The tide\'s rampart, made bearable. The sea builds symmetric; the smith didn\'t argue.',
  },
  {
    id: 'wintercourt_rime',
    name: 'Wintercourt rime',
    slot: 'offhand',
    levelReq: { skill: 'defence', level: 30 },
    armor: 7,
    affixPool: [{ stat: 'defence', w: 2 }, { stat: 'arx', w: 2 }, { stat: 'maxHp' }, { stat: 'regen' }],
    acquisition: { drop: true },
    value: 780,
    color: '#cfd8d2',
    code: 'Wq',
    desc: 'The Court does not carry weight. It confers it. Mind your manners.',
  },
  {
    id: 'nightveil_pinion',
    name: 'Nightveil pinion',
    slot: 'offhand',
    levelReq: { skill: 'defence', level: 33 },
    armor: 9,
    affixPool: [{ stat: 'defence', w: 2 }, { stat: 'sneak', w: 2 }, { stat: 'maxHp' }, { stat: 'vitality' }],
    acquisition: { drop: true },
    value: 950,
    color: '#2e3345',
    code: 'Nv',
    desc: 'A raised wing between you and the answer. Three gold lines in the dark.',
  },
  {
    id: 'vale_reliquary',
    name: 'Vale reliquary',
    slot: 'offhand',
    levelReq: { skill: 'defence', level: 36 },
    armor: 10,
    affixPool: [{ stat: 'defence', w: 2 }, { stat: 'arx' }, { stat: 'regen', w: 2 }, { stat: 'maxHp' }],
    acquisition: { craft: true },
    recipe: {
      skill: 'smithing',
      levelReq: 44,
    ...
    color: '#28324f',
    code: 'Vq',
    desc: 'Shrine architecture with straps. Polished by every mile of the pilgrim way.',
  },
  {
    id: 'cindermaw_bulwark',
    name: 'Cindermaw bulwark',
    slot: 'offhand',
    levelReq: { skill: 'defence', level: 38 },
    armor: 10,
    affixPool: [{ stat: 'defence', w: 2 }, { stat: 'onehand', w: 2 }, { stat: 'maxHp' }, { stat: 'vitality' }],
    ...
    color: '#3e3a38',
    code: 'Cw',
    desc: 'A furnace door that never agreed to retire. The seams are still burning.',
  },
  {
    id: 'everwood_crest',
    name: 'Everwood crest',
    slot: 'offhand',
    levelReq: { skill: 'defence', level: 40 },
    armor: 10,
    affixPool: [{ stat: 'defence', w: 2 }, { stat: 'arx', w: 2 }, { stat: 'regen' }, { stat: 'maxHp' }],
    acquisition: { craft: true },
    recipe: {
      skill: 'woodworking',
      levelReq: 46,
    ...
    color: '#e8e0cc',
    code: 'Ew',
    desc: 'A silverbark leaf the length of you. The grain remembers agreeing.',
  },
  {
    id: 'gatefall_bulwark',
    name: 'Gatefall bulwark',
    slot: 'offhand',
    levelReq: { skill: 'defence', level: 44 },
    armor: 11,
    affixPool: [{ stat: 'defence', w: 3 }, { stat: 'maxHp', w: 2 }, { stat: 'arx' }, { stat: 'vitality' }],
    acquisition: { drop: true },
    value: 1600,
    color: '#3e3560',
    code: 'Gq',
    desc: 'A window onto a place nobody has finished looking into. Keep it between you and it.',
  },
  {
    id: 'aldarens_gate',
    name: 'Aldaren\'s Gate',
