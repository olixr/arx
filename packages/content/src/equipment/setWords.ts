...
export const SET_WORDS: Record<string, SetWord[]> = {
  ...
  dreadforge: [
    W(2, 'Dread Grip', '+3% two-handed damage.',
      { kind: 'styleDmg', style: 'twohand', pct: 3 }),
    W(4, 'The Dread Feeds', 'Bleeding foes take 25% more from you.',
      { kind: 'vsState', status: 'bleed', pct: 25 }),
  ],
  sunforged: [
    W(2, 'Gilded Light', '+4% radiant damage.',
      { kind: 'elementDmg', element: 'radiant', pct: 4 }),
  ...
  drakescale: [
    W(2, 'Scale Guard', '+2 defence.',
      { kind: 'skill', skill: 'defence', amount: 2 }),
  ...
  // ================================================ chase cloth
  moonbell: [
    W(2, 'Meadow Learning', '+3% verdant damage.',
      { kind: 'elementDmg', element: 'verdant', pct: 3 }),
    W(4, 'What Poisons the Fen', 'Venomed foes take 30% more from you.',
      { kind: 'vsState', status: 'venom', pct: 30 }),
  ],
  riftweave: [
    W(2, 'Cut From Between', '+2 enchanting.',
      { kind: 'skill', skill: 'enchanting', amount: 2 }),
  ...
  wintercourt: [
    W(2, 'Glacial Silk', '+3 tailoring.',
      { kind: 'skill', skill: 'tailoring', amount: 3 }),
  ...
  sunhallow: [
    W(2, 'Dawn Lit', '+5% radiant damage.',
      { kind: 'elementDmg', element: 'radiant', pct: 5 }),
  ...
  gloamsight: [
    W(2, 'Veiled Eye', '+4% arcane damage.',
      { kind: 'elementDmg', element: 'arcane', pct: 4 }),
  ...
  duskwarden: [
    W(2, 'Traveling Weight', '+2 foraging.',
      { kind: 'skill', skill: 'foraging', amount: 2 }),
  ...
  aetherion: [
    W(2, 'Living Script', '+3 enchanting.',
      { kind: 'skill', skill: 'enchanting', amount: 3 }),
  ...
  hartsong: [
    W(2, 'Greenwood Keeping', '+2 woodcutting.',
      { kind: 'skill', skill: 'woodcutting', amount: 2 }),
  ...
  skytalon: [
    W(2, 'Hawk Eye', '+2% archery damage.',
      { kind: 'styleDmg', style: 'archery', pct: 2 }),
  ...
  cindershade: [
    W(2, 'Warm Seams', '+3% ember damage.',
      { kind: 'elementDmg', element: 'ember', pct: 3 }),
  ...
  // ================================================ chase plate
  aurochs: [
    W(2, 'Horned Hide', '+3 thorns.',
      { kind: 'thorns', amount: 3 }),
  ...
  barrowking: [
    W(2, 'Barrow Iron', '+3 defence.',
      { kind: 'skill', skill: 'defence', amount: 3 }),
  ...
  stormcrown: [
    W(2, 'Slate Weight', '+3 shield.',
      { kind: 'skill', skill: 'shield', amount: 3 }),
  ...
  forgeheart: [
    W(2, 'Hot Iron', '+2 mining.',
      { kind: 'skill', skill: 'mining', amount: 2 }),
  ...
  wyrmsteel: [
    W(2, 'Sung Steel', '+2 smithing.',
      { kind: 'skill', skill: 'smithing', amount: 2 }),
  ...
  fellbone: [
    W(2, 'Fell Guard', '+2 vitality.',
      { kind: 'skill', skill: 'vitality', amount: 2 }),
  ...
  redmarch: [
    W(2, 'March Order', '+3% polearm damage.',
      { kind: 'styleDmg', style: 'polearm', pct: 3 }),
  ...
  rimethorn: [
    W(2, 'Thorned Quench', '+3% frost damage.',
      { kind: 'elementDmg', element: 'frost', pct: 3 }),
  ...
  kingsmane: [
    W(2, 'Guard Bearing', '+3 vitality.',
      { kind: 'skill', skill: 'vitality', amount: 3 }),
  ...
  adderking: [
    W(2, 'The Long Coil', '+4% verdant damage.',
      { kind: 'elementDmg', element: 'verdant', pct: 4 }),
  ...
  stormtalon: [
    W(2, 'Storm Eye', '+4% storm damage.',
      { kind: 'elementDmg', element: 'storm', pct: 4 }),
