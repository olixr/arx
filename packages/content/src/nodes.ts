...
export const NODES: NodeDef[] = [
  ...
  // The fishing ladder (XP balance epic): the trout spot stays the
  // everywhere anchor and never depletes; the tiers read the water
  // they sit in (fen stillwater, deep channels, the cold country) and
  // DO rest between bites — the angler walks the shore, never camps
  // one tile. Fishing has no growth dialect on purpose (second-growth
  // law), so a rested spot rides the plain respawn queue.
  {
    id: 'pike_hole',
    tile: Tile.PikeHole,
    name: 'Pike hole',
  ...
  {
    id: 'glimmer_shoal',
    tile: Tile.GlimmerShoal,
    name: 'Glimmer shoal',
    skill: 'fishing',
    levelReq: 60,
    xp: 210,
    yieldItem: 'raw_glimmerfish',
    tool: 'rod',
    baseTicks: 110,
    depleteChance: 0.3,
    depletedTile: Tile.Water,
